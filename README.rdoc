...
In Level 4, I used scaffold to create the Thing model and related files.  This is useful as a reference for the correct methods, strong parameters, etc., but not recommended in general, because it creates methods that may not be relevant, and even dangerous, such as the delete method. 
